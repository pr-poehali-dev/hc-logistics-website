...
const Index = () => {
  ...
  const services = [
    ...
    },
    {
      icon: 'Train',
      title: 'ЖД Перевозки',
      description: 'Железнодорожные перевозки любых объемов по России и СНГ с оптимальными тарифами',
      features: ['Контейнерные перевозки', 'Полувагоны и платформы', 'Мультимодальные решения']
    },
    {
      icon: 'Droplet',
      title: 'Доставка на Месторождения',
      description: 'Специализированные доставки для нефтегазовой отрасли с учетом специфики удаленных объектов',
      features: ['Вахтовая логистика', 'Северный завоз', 'Работа в сложных условиях']
    },
    {
      icon: 'AlertTriangle',
      title: 'Опасные Грузы',
      description: 'Перевозка опасных грузов всех классов по ДОПОГ с полным соблюдением требований безопасности',
      features: ['Лицензированные перевозчики', 'ADR/ДОПОГ сертификация', 'Аварийные карты']
    },
    {
      icon: 'Maximize2',
      title: 'Крупногабаритные Грузы',
      description: 'Перевозка негабаритных и тяжеловесных грузов с проработкой маршрутов и разрешений',
      features: ['Спецтехника до 200 тонн', 'Согласование маршрутов', 'Сопровождение ГИБДД']
    }
  ];
        ...
        <div className="container mx-auto relative z-10">
          <div className="text-center max-w-5xl mx-auto mb-20">
            ...
            <p className="text-xl md:text-2xl text-white/60 mb-12 leading-relaxed max-w-3xl mx-auto">
              Логистические решения полного цикла. 
